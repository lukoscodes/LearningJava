public class PhraseOMatic {
    public static void main(String[] args) {
        ...
        String[] wordListTwo = {"event drive", "pub-sub", "IoT", "cloud native", "service oriented", "containerized", "serverless", "microservices", "distributed ledger"};
        ...
        java.until.Random randomGenerator = new java.until.Random();
